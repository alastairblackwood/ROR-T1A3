...
module Ror
  ...
  STORY_INTRO = [
    "You have travelled many months across the trecherous" + " " + "Land of Redoc".colorize(:red) + 
    ". 
  ...
  STORY_ENDING = [
    ...
    "",
    "But you will always be ready... for when the world needs you again".yellow,
    "",
